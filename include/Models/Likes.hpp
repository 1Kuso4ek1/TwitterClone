...
class Likes
{
  public:
    ...
    using PrimaryKeyType = std::tuple<int32_t,int32_t>;//user_id,post_id
  ...
  public:
    ...
    {
        static const std::string sql="select * from " + tableName + " where user_id = $1 and post_id = $2";
        return sql;
    }

    static const std::string &sqlForDeletingByPrimaryKey()
    {
        static const std::string sql="delete from " + tableName + " where user_id = $1 and post_id = $2";
        return sql;
    }
